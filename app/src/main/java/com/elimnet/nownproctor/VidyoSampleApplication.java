...
//			pathDir = getAndroidSDcardMemDir();
			...
			pathDir = "/data/data/com.elimnet.nownproctervd/app_marina/";
		}
...
//			logDir = getAndroidSDcardMemDir();
			...
			logDir = "/data/data/com.elimnet.nownproctervd/app_marina/";
		}
	...
	public void RenderCalledCallback(){
		Log.d(TAG, "******Rendere called received!");
		Message msg = Message.obtain();
		msg.setTarget(hdlr);
		msg.what = VidyoSampleActivity.RENDERER_CALLED;
		msg.sendToTarget();
	}
